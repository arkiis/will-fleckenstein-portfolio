...
import { MediaStageOrbs } from "./MediaStageBackground";

/** Shared framed media shell — matches Initial Struggle section. */
export const MEDIA_FRAME_CLASS =
  "relative isolate overflow-hidden rounded-sm border border-[var(--portfolio-border)]/10 px-4 py-6 sm:px-6 sm:py-8";
...
type TwineCaseStudyMediaFrameProps = {
  ...
  className?: string;
  background?: string;
  /** Floating orbs over the frame gradient (does not replace the parent background). */
  mediaOrbs?: boolean;
};
